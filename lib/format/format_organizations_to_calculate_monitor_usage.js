 ...
 * @returns {Array} Array of objects; where object has properties Organization Name, No. Of Monitors
 * and No. of Submissions by date
 */
const toOrganizationsToCalculateMonitorUsage = (organizations) => {
  const submissions = [];
...
module.exports = toOrganizationsToCalculateMonitorUsage;
